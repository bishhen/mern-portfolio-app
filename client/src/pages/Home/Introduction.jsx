...
function Introduction() {
  return (
    <div className='h-[80vh] bg-primary flex flex-col items-start justify-center gap-8 py-10'>
        ...
        <h1 className='text-7xl sm:text-3xl text-secondary font-semibold'>Bishana Parindi</h1>
        <h1 className='text-7xl sm:text-3xl text-white font-semibold'>I'm a full stack developer</h1>
